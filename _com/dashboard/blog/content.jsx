...
export default function BlogContent({article, setArticle, setArticles, toggle, setToggle}) {
    ...
    return(
        <div className={styles.BlogContent} >
            <div className={styles.BlogAction}>
                <p>Blog</p>
                <span onClick={()=>setToggle(true)}> <Icon name={'Plus'} color={'white'}/> </span>
            </div>
            ...
            {(!article && !toggle)?
                ...
                :
                (article && !toggle)?
                    <BlogArticle  article={article} setArticle={setArticle} setArticles={setArticles}/>
                    :
                    <BlogAdd setToggle={setToggle} setArticle={setArticle} setArticles={setArticles}/>
            }
