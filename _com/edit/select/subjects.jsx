...
import { ModifySubjects } from "@/_lib/listings/editdata";

export default function EditSubjects({subjects, allsubjects, listing_id, handleEdit, setListing}) {
    
    const [selected, setSelected] = useState(subjects.map((e)=>e.name));
    ...
    async function HandleMaplink(){
        ...
        const result = await ModifySubjects(listing_id, selected); 
        setLoading(false)
